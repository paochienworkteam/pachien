  ...
  <body>
              ...
              <?php if($members):?>
                <?php foreach($members as $member):?>
                  <tr>
                    ...
                    <td>
                      <a href='member_edit.php?i=<?php echo $member['user_id'];?>' class="btn btn-default">編輯</a>
                      <a href='javascript:void(0);' class='btn btn-default del_member' data-id="<?php echo $member['user_id'];?>">刪除</a>
                    </td>
                  </tr>
                <?php endforeach;?>
              <?php else:?>
    ...
    <script>
    	//$(document).on("ready", function(){
            ...
            data : {
              user_id : $(this).attr("data-id") //使用者id
            },
